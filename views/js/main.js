...
var resizePizzas = function(size) { 
  ...
  //   Took out for loop, instead added CSS classes to determine the size of pizzas, thus changing them all at once.
...
//   Create array of phase numbers, so this doesn't have to be calculated for each pizza, each time.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // CHANGE:  We don't need 200 of these moving pizzas.  Changed to 35.
  for (var i = 0; i < 35; i++) {
